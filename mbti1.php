  ...
  <div class="card border-0 rounded-0 shadow">
    <div class="container card-body p-5">
     ...
     <?php $number--;
      ...
      <a class="btn btn-primary btn-sm" href="student_evaluation.php" role="button"><ion-icon name="caret-back-sharp"></ion-icon>Cancel</a>
