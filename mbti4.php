  ...
  <div class="card border-0 rounded-0 shadow">
    <div class="container card-body p-5">
      <div class="text-center">
        ...
        <label class="">Set 4: Answer The following</label> 
      </div>
     <?php while($number!=21): ?>
      <div class="mt-3">
     ...
     <?php $number--;
      ...
      <a class="btn btn-primary btn-sm" href="mbti3.php" role="button"><ion-icon name="caret-back-sharp"></ion-icon>Back</a>
      <button class="btn btn-primary btn-sm button-submit " onclick="check()" type="submit"><ion-icon name="caret-forward-sharp"></ion-icon>Finished</button>
      </div>
    </div>
  </div>
</form>
